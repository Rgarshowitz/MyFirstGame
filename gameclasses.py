class Game:
    ...
    def noOfQuestions(self, value):
        if value < 1:
            ...
            print("Hence, number of questions will beset to 10")
        else:
    ...
    class BinaryGame(Game):
        def generateQuestions(self):
            ...
            for i in range(self.noOfQuestions):
                ...
                userResult = input("\nPlease conver %d to binary: " %(base10))
                while True:
                    try:
                        ...
                        if answer == base10:
                            ...
                            print("Sorry, Wrong Answer, The correct answer is {:b}. ".formant(base10))
                            break
                        except:
        ...
        def generateQuestions(self):
            ...
            for i in range(self.noOfQuestions):
                ...
                for index in range(0, 4):
                    ...
                    for index in range(0, 4):
                        questionString = questionsString + symbolList[index] + str(numberList[index+1])
                    ...
                    while True:
                        try:
                            ...
                            if answer == result:
                                ...
                                print("Sorry, wrong answer. The Correct answer is {:d}.".format(result))
                                break
                            except:
